...
| F22.1 | ~~Sticky claim-anchor toggle in wiki-reader header~~ — **Done 2026-05-03** (button next to Edit, same global signal as Settings → Visning, instant flip via @preact/signals .value reads) | F22 | Tiny |
