...
| F189 | [Upmetrics Cost Integration (ai-sdk sink + read-API display)](features/F189-upmetrics-cost-integration.md) | Planned (blocked on deps) | 2 | [plan](features/F189-upmetrics-cost-integration.md) |
...
### F189 — Upmetrics Cost Integration
