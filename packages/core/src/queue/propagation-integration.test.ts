 ...
 *
 * AC#2 er den vigtige: rammer afløsningen kun source-Neuronen, bliver køen ren
...
test('AC#5 DEN BÆRENDE: en GENKOMPILERING udløser forplantningen på den ægte vej', async () => {
  ...
  expect(f[0]!.title).toContain('1 side hænger på en source');
...
test('NEGATIV KONTROL — en kompilering UDEN kendt source forplanter intet', async () => {
